...
// SVG keeps `agent-tab share` dependency-free and converts cleanly to PNG later.
...
export function renderCardSvg(r: RunReport): string {
  ...
  <!-- header -->
  <text x="40" y="58" font-size="22" font-weight="800" fill="#e8eaed">Agent Tab</text>
  ...
  <text x="${W - 40}" y="${H - 18}" text-anchor="end" font-size="12" fill="#5f6671">npx agent-tab</text>
</svg>`;
}
